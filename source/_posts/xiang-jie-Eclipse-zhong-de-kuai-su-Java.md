...
### 图1. 从列表中选择模板
![eclipse1.gif]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/eclipse1.gif)

## 三、编辑模板
通过选择Window > Preferences打开Eclipse Preferences，转到Java > Editor > Templates查看现有模板。单击列表中的模板并单击Edit编辑，Edit Template窗口出现（如图2）。

### 图2. 编辑模板
![eclipse2.gif]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/eclipse2.gif)
...
### 图3. 自动插入值
![eclipse3.gif]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/eclipse3.gif)
