...
![如果示例]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/if_1589633826630.png)
...
![做例子]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/do_1589633860170.png)
...
![while-example]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/while_1589633937937.png)
...
![每个例子]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/for-each_1589633972398.png)
[](#nesting-commands)嵌套命令
-------------------------

您可以根据需要嵌套控制流命令（例如，一个`if`块可以放在一个`while`块内部，反之亦然）。

![嵌套示例]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/nested_1589634003147.png)
[](#syntax-validation)语法验证
--------------------------

如果不确定控制流语法是否正确，请尝试运行测试以查看。IDE将发现控制流语法中的错误，并调出不正确或丢失的特定命令。

![错误示例]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/error_1589634033058.png)