...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691986990751.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987008015.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987018782.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987033869.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987083834.png)

那么解析后需要对 HTML 文本进行截取，就像下图这样：

![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987095110.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987122110.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987138982.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987161522.png)

### CSS 盒子模型

在 CSS 中，所有的 DOM 节点都可以当作一个盒子。这个盒子模型包含了内容、内边距、边框、外边距以及在页面中的位置信息。

![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987170826.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987183794.png)

内联布局则会将盒子从左至右的水平排列。

![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987194562.png)

如果容器内同时存在块布局和内联布局，则会用一个匿名布局将内联布局包裹起来。

![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987205365.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987233030.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987248996.png)

### 绘制线条

如果我们要在计算机上绘制一条直线，那么只要知道计算机的起点坐标 `(x1,y1)` 和终点坐标 `(x2,y2)` 就可以了。

![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987257964.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987272246.png)
...
![image.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/image_1691987293758.png)
