...
在[Pyhton中](https://www.tushu.info/archives/Python-ji-chu-jiao-cheng)，**元组**类似于**不变**，list但**不可变**，并带有可选的**圆括号**。
...
元组支持类似于[list](https://www.tushu.info/archives/Python-zhong-de-list-cao-zuo/)类型的操作，只有我们不能更改元组元素。
