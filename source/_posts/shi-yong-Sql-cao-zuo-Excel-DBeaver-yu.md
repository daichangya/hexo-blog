---
title: 使用Sql操作Excel-DBeaver 与 Excel JDBC 驱动使用说明
id: c69c36ac-0033-4cb7-96c2-7ac5d66b91e9
date: 2025-08-27 09:52:26
author: daichangya
excerpt: 项目地址github https//github.com/daichangya/xlsql 1. 概述 本文档详细介绍了如何在 DBeaver 中配置和使用
  Excel JDBC 驱动来连接和操作 Excel 文件。Excel JDBC 驱动允许用户像操作数据库一样查询和修改 Excel 文件中
permalink: /archives/shi-yong-Sql-cao-zuo-Excel-DBeaver-yu/
categories:
- java
tags:
- jdbc
