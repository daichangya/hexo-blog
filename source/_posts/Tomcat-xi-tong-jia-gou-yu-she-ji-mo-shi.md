...
![图 1. 门面示意图]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/j-lo-tomcat2_images_image001.jpg)
...
![图 2. Request 的门面设计模式类图]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/j-lo-tomcat2_images_image002.png)
...
![图 3. Lifecycle 的观察者模式结构图]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/j-lo-tomcat2_images_image003.png)
...
![图 4. Tomcat 命令模式的结构图]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/j-lo-tomcat2_images_image004.png)
...
![图 5. Tomcat 责任链模式的结构图]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/j-lo-tomcat2_images_image005.jpg)
