---
title: Spring 框架的设计理念与设计模式分析
id: 1094
date: 2024-10-31 22:01:49
author: daichangya
excerpt: 简介： Spring 作为现在最优秀的框架之一，已被广泛的使用，并且有很多对其分析的文章。本文将从另外一个视角试图剖析出 Spring 框架的作者设计
  Spring 框架的骨骼架构的设计理念，有那几个核心组件？为什么需要这些组件？它们又是如何结合在一起构成 Spring 的骨骼架构？ Spring 的 AOP
  特性又是如何利用这些基础的骨骼
permalink: /archives/Spring-kuang-jia-de-she-ji-li-nian-yu/
categories:
- spring
- 设计模式
---
...
![图 1 .Spring 框架的总体架构图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image001.gif)
...
![图 2. 三个组件关系](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image002.gif)
...
![图 4. Bean 工厂的继承关系](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image003.png)
...
![图 5. Bean 定义的类层次关系图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image004.png)
...
![图 6. Bean 的解析类](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image005.png)
...
![图 7. Context 相关的类结构图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image006.png)


（查看 [图 7 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image006.png)。）
...
![图 8. Resource 相关的类结构图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image007.png)


（查看 [图 8 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image007.png)。）
...
![图 9. Context 和 Resource 的类关系图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image008.png)
...
![图 10. DefaultListableBeanFactory 类继承关系图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image009.png)


（查看 [图 10 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image009.png)。）
...
![图 11. 创建 BeanFactory 时序图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image010.png)


（查看 [图 11 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image010.png)。）

Bean 的解析和登记流程时序图如下：

##### 图 12\. 解析和登记 Bean 对象时序图

![图 12. 解析和登记 Bean 对象时序图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image011.png)


（查看 [图 12 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image011.png)。）
...
![图 13.Bean 实例创建流程图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image012.gif)


（查看 [图 13 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image012.gif)。）

如果是普通的 Bean 就直接创建他的实例，是通过调用 getBean 方法。下面是创建 Bean 实例的时序图：

##### 图 14.Bean 实例创建时序图

![图 14.Bean 实例创建时序图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image013.png)


（查看 [图 14 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image013.png)。）

还有一个非常重要的部分就是建立 Bean 对象实例之间的关系，这也是 Spring 框架的核心竞争力，何时、如何建立他们之间的关系请看下面的时序图：

##### 图 15.Bean 对象关系建立

![图 15.Bean 对象关系建立](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image014.png)


（查看 [图 15 的清晰版本](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/origin_image014.png)。）
...
![图 16. Proxy 类结构](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image015.png)
...
![图 17. 创建代理对象时序图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image016.png)
...
![图 18. Jdk 动态代理的类图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image017.png)
...
![图 19.Spring 代理对象的产生](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image018.png)
...
![图 20.Spring 调用拦截器](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image019.png)
...
![图 21. 代理模式的结构](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image020.png)
...
![图 22. Spring 中使用代理模式的结构图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image021.gif)
...
![图 23. 策略模式的结构](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image022.png)
...
![图 24. Spring 中策略模式结构图](https://www.ibm.com/developerworks/cn/java/j-lo-spring-principle/image023.png)
...
*   [Spring 系列: Spring 框架简介](http://www.ibm.com/developerworks/cn/java/wa-spring1/)：在这由三部分组成的介绍 Spring 框架的系列文章的第一期中，将开始学习如何用 Spring 技术构建轻量级的、强壮的 J2EE 应用程序。
*   [AOP@Work: 用 AspectJ 和 Spring 进行依赖项插入](http://www.ibm.com/developerworks/cn/java/j-aopwork13.html)依赖项插入和面向方面编程是互补的技术，所以想把它们结合在一起使用是很自然的。本文探索两者之间的关系，并了解怎样才能把它们组合在一起，来促进高级的依赖项插入场景。
*   查看本文作者的其它文章：[Tomcat 系统原理分析](http://www.ibm.com/developerworks/cn/java/j-lo-tomcat1/)和 [Tomcat 设计模式分析](http://www.ibm.com/developerworks/cn/java/j-lo-tomcat2/)。
*   [IBM Developer（developerWorks）中国 Java 技术专区](http://www.ibm.com/developerworks/cn/java/)：数百篇关于 Java 编程各个方面的文章。
*   [Spring Framework 官网 网站](https://spring.io/projects/spring-framework)：下载 Spring 框架。
