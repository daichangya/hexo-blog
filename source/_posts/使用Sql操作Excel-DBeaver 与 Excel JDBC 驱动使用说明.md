...
author: daichangya
excerpt: "项目地址github https//github.com/daichangya/xlsql 1. 概述 本文档详细介绍了如何在 DBeaver 中配置和使用 Excel JDBC 驱动来连接和操作 Excel 文件。Excel JDBC 驱动允许用户像操作数据库一样查询和修改 Excel 文件中"
permalink: /archives/shi-yong-sqlcao-zuo-excel-dbeaver/
categories:
 - java
tags: 
 - jdbc
