...
理查德·费曼曾经说过：“不要欺骗自己，你自己正是最容易被欺骗的人。”这句话用来说明编写 Java 微基准测试这件事是再合适不过了。
...
总之，请打开 GC 日志，以此来确定停顿时间是否真的影响了应用。通过分析日志来确定停顿时间，这里既可以手工分析，也可以利用脚本或工具分析。然后再判定它们是否真的给应用于带来了问题。最重要的是，问自己一个关键的问题：确实有用户抱怨吗？
