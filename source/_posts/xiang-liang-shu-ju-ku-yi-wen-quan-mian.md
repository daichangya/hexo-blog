...
author: daichangya
permalink: /archives/xiang-liang-shu-ju-ku-yi-wen-quan-mian/
categories:
- 大模型
tags:
- 向量数据库
...
![118a158cb45916b46adb0c8dd79d4f8c.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/118a158cb45916b46adb0c8dd79d4f8c_1727006405116.png)
...
![157ad4258f46d658f381042a3d86840a.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/157ad4258f46d658f381042a3d86840a_1727006453480.png)

然而单靠一个体型大小的特征并不够，像照片中哈士奇、金毛和拉布拉多的体型就非常接近，我们无法区分。所以我们会继续观察其它的特征，例如毛发的长短。

![f058c6a412a39ad68b56fcce87392b68.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/f058c6a412a39ad68b56fcce87392b68_1727006463143.png)
...
![792db1960a60aba16252c7f90d35e89e.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/792db1960a60aba16252c7f90d35e89e_1727006490824.png)
...
![d3225e349c5a797e264c469ce482bcc4.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/d3225e349c5a797e264c469ce482bcc4_1727006533077.jpeg)

那么为了解决搜索时可能存在的遗漏问题，可以将搜索范围动态调整，例如当 nprobe = 1 时，只搜索最近的一个聚类中心，当 nprobe = 2 时，搜索最近的两个聚类中心，根据实际业务的需求调整 nprobe 的值。

![59d8d91dd90bd334afe383b360628883.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/59d8d91dd90bd334afe383b360628883_1727006542673.jpeg)
...
![f9f6b2cf1f6a0ea0239ebfc22f28b4ea.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/f9f6b2cf1f6a0ea0239ebfc22f28b4ea_1727006582839.jpeg)
...
![2feebc6eddf045e0446ee88027262b07.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/2feebc6eddf045e0446ee88027262b07_1727006596252.jpeg)

解决这个问题的思路与常见的跳表算法相似，如下图要搜索跳表，从最高层开始，沿着具有最长“跳过”的边向右移动。如果发现当前节点的值大于要搜索的值-我们知道已经超过了目标，因此我们会在下一级中向前一个节点。

![5bd0cb4994c556f2c797be3ffff80c6e.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/5bd0cb4994c556f2c797be3ffff80c6e_1727006622141.jpeg)
...
![22e79a20c0196fec427975dd324df4b7.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/22e79a20c0196fec427975dd324df4b7_1727006670725.png)
...
![bdf8570b0ef82450e0cd1ff5a5678484.png]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/bdf8570b0ef82450e0cd1ff5a5678484_1727006680231.png)
...
![2ecfe904e6cdf7827d3f739f607593a9.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/2ecfe904e6cdf7827d3f739f607593a9_1727007116128.jpeg)
...
![57bad3e8f2e24ca39f56f3e716637761.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/57bad3e8f2e24ca39f56f3e716637761_1727007133392.jpeg)
...
![855773ca958ef48963beb902e7b354ff.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/855773ca958ef48963beb902e7b354ff_1727007143410.jpeg)
...
![257b8a4ec4a06bd7f10a34ad60ee172e.jpeg]( https://mdanimage.oss-cn-shenzhen.aliyuncs.com/257b8a4ec4a06bd7f10a34ad60ee172e_1727007154346.jpeg)
